...
The **Hello-world** is a simple web app built with Ruby on Rails and react that display a random greeting that was fetched from a database API.
...
```
  git clone https://github.com/AmineDerbal/Hello-world-ROR-React-App.git
  cd Hello-world-ROR-React-App
```
...
Feel free to check the [issues page](https://github.com/AmineDerbal/Hello-world-ROR-React-App/issues).
